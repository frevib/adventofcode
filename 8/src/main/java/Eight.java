...
public class Eight {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // put all registers in a hashmap
        for (String instruction : instructionsList) {
            String[] parts = instruction.split("\\s");
            registers.put(parts[0], 0);
            registers.put(parts[4], 0);
        }
        ...
        for (String instruction : instructions) {
            ...
            if (evaluateExpression(parts[4], parts[5] + parts[6])) {
                if (parts[1].equals("inc")) {
                    int total = registers.get(parts[0]) + Integer.parseInt(parts[2]);
                    registers.put(parts[0], total);
                    if (total > max) {
                        max = total;
                    }
...
//        printRegisters();
        printMaxRegister();
        System.out.println("Max value ever: " + max);
    }


    public static boolean evaluateExpression(String register, String expression) throws Exception {
        boolean result = (Boolean) scriptEngine.eval(registers.get(register) + expression);
//        System.out.println(result);
    ...
    public static void printMaxRegister() {
    ...
    public static String testInput = "b inc 5 if a > 1\n" +
            "a inc 1 if b < 5\n" +
            "c dec -10 if a >= 1\n" +
            "c inc -20 if c == 10";

    public static String input = "av inc 167 if f > -9\n" +
            "av inc 640 if uea == 0\n" +
            "fk dec -960 if tn > -9\n" +
